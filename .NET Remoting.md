...
![image-20210518113143257](.NET Remoting.assets/image-20210518113143257.png)
...
![image-20210519091039703](.NET Remoting.assets/image-20210519091039703.png)
...
![image-20210519091858654](.NET Remoting.assets/image-20210519091858654.png)
...
![image-20210519092106925](.NET Remoting.assets/image-20210519092106925.png)

在上图中可见HttpServerChannel采用soap协议传输对象。深究其实现

![image-20210519092343993](.NET Remoting.assets/image-20210519092343993.png)

构造函数中进入`this.SetupChannel()`

![image-20210519092422683](.NET Remoting.assets/image-20210519092422683.png)

然后判断自身_sinkProvider是否为空，如果为空则CreateDefaultServerProviderChain()

![image-20210519092515200](.NET Remoting.assets/image-20210519092515200.png)

这里使用了一个Provider链，从SdlChannelSinkProvider->SoapServerFormatterSinkProvider->BinaryServerFormatterSinkProvider

![image-20210519102848623](.NET Remoting.assets/image-20210519102848623.png)

而TcpServerChannel中，使用的是BinaryServerFormatterSinkProvider->SoapServerFormatterSinkProvider

![image-20210519103010772](.NET Remoting.assets/image-20210519103010772.png)
...
![image-20210519104330838](.NET Remoting.assets/image-20210519104330838.png)
...
![image-20210519105336744](.NET Remoting.assets/image-20210519105336744.png)
...
![image-20210519110547764](.NET Remoting.assets/image-20210519110547764.png)
...
![image-20210519114342537](.NET Remoting.assets/image-20210519114342537.png)
...
![image-20210519114959230](.NET Remoting.assets/image-20210519114959230.png)
